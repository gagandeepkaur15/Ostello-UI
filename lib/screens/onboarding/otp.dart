...
class OnboardingOtpVerificationScreen extends StatefulWidget {
  final String number;
  const OnboardingOtpVerificationScreen({
    super.key,
    required this.number,
  });

  @override
  State<OnboardingOtpVerificationScreen> createState() =>
      _OnboardingOtpVerificationScreenState();
}

class _OnboardingOtpVerificationScreenState
    extends State<OnboardingOtpVerificationScreen> {
  late Timer _timer;
  int _start = 18;
